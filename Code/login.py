...
from forgotpassword import Ui_ForgotPassword  # Import the forgot password UI
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.label.setText('<a href="#">Forgot Password?</a>')
        self.label.setOpenExternalLinks(False)
        self.label.linkActivated.connect(self.forgot_password)
    ...
    def forgot_password(self):
        ...
        self.forgot_password_dialog = QtWidgets.QDialog()
        self.ui = Ui_ForgotPassword()
        self.ui.setupUi(self.forgot_password_dialog, self.Dialog)
        self.Dialog.hide()
